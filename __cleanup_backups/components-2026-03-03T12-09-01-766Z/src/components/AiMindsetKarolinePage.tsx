...
export default function AiMindsetKarolinePage() {
  ...
  return (
    <div ref={containerRef} className="h-screen overflow-y-scroll bg-[#E6E1EB] text-black selection:bg-black selection:text-[#E6E1EB] hide-scrollbar font-grotesk">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#E6E1EB]">
        <Marquee text="AI MINDSET POS {SPRINT} . BATCH X26 . PERSONAL OPERATIONAL SYSTEM . MAR 2 — MAR 14" speed={40} />
      </div>
      ...
      <main className="pt-12">
        ...
        <section>
          <div className="border-b-2 border-black py-4 px-4 text-xs uppercase tracking-widest font-bold">
            The 4 Pillars of POS
          </div>
          
          <TextBand text="Context . Context . Context ." delay={0.1} />
          <div className="px-4 py-8 md:px-12 md:py-12 border-b-2 border-black bg-[#E6E1EB] text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-center">
             AI knows who you are, how you work, and what matters to you. A deep understanding of your personal workflow.
          </div>

          <TextBand text="Architecture . Architecture ." delay={0.1} />
          <div className="px-4 py-8 md:px-12 md:py-12 border-b-2 border-black bg-[#E6E1EB] text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-center">
             A system that won't delete files without asking. Structured, safe, and built for scale.
          </div>

          <TextBand text="Tools . Tools . Tools . Tools ." delay={0.1} />
          <div className="px-4 py-8 md:px-12 md:py-12 border-b-2 border-black bg-[#E6E1EB] text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-center">
             Seamless integration with Claude Code, Cursor, Obsidian, and MCP. Your stack, unified.
          </div>

          <TextBand text="Skills . Skills . Skills . Skills ." delay={0.1} />
          <div className="px-4 py-8 md:px-12 md:py-12 border-b-2 border-black bg-[#E6E1EB] text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-center">
             Automation of routine tasks. Agents that handle the busywork so you can focus on strategy.
          </div>
        </section>
        ...
        <section className="border-b-2 border-black">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 divide-y-2 md:divide-y-0 md:divide-x-2 divide-black">
              {[
                { name: "Alexander Povalyaev", role: "Founder", desc: "Strategist. 15+ years connecting tech & people." },
                { name: "Sergey Khabarov", role: "Architect", desc: "System Architect. 6+ years in EdTech & AI." },
                { name: "Seryozha Ris", role: "Evangelist", desc: "AI Evangelist. Ex-Yandex. Vibe coder." }
              ].map((guide, i) => (
        ...
        <section className="relative py-24 md:py-48 flex flex-col items-center justify-center text-center px-4 overflow-hidden">
           ...
           <p className="text-xl md:text-2xl max-w-2xl mb-12 relative z-10">
              Leave with a working system, not just notes. <br/>
              Refund within first 4 days — no questions asked.
           </p>
        ...
        <div className="border-t-2 border-black">
          <Marquee text="SCROLL TO SEE MORE . SCROLL TO SEE MORE . SCROLL TO SEE MORE" direction={-1} speed={30} />
        </div>
