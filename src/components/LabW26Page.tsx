...
export default function LabW26Page() {
  ...
  return (
    ...
    >
      ...
      {/* Ticker Top */}
      {/* DO NOT MODIFY: Top news ticker bar style is approved and finalized. It should not be touched during redesigns. */}
      ...
      {/* Header */}
      {/* Removed backdrop-blur-sm as requested to provide a more solid background feel */}
      <header className="fixed top-6 left-0 w-full z-50 px-4 md:px-8 py-4 flex justify-between items-center bg-white/10 border-b border-current/10" style={{ backgroundColor: theme === 'winter' ? '#f9f9f7' : '#f2f9f2' }}>
        <div className="flex gap-8 items-center">
          ...
          <nav className="flex md:hidden gap-3 text-[9px] md:text-[10px] font-bold tracking-widest items-center">
            {DESKTOP_PAGE_NAV.map((link) => (
              <button
                key={link.label}
      ...
      {/* DO NOT MODIFY: Mobile menu design and animation are approved and finalized. Do not change its style during redesigns. */}
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
